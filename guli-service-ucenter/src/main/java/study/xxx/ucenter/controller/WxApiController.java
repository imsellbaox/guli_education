...
import study.xxx.ucenter.utils.ConstantWxUtils;
import study.xxx.ucenter.utils.HttpClientUtils;
    ...
    public String callback(String code,String state){
        ...
        try{
            ...
            if (ucenterMember == null){
                ...
                String vxUserInfo = HttpClientUtils.get(userInfoUrl);
                System.out.println("vxUserInfo:"+vxUserInfo);
                //获取返回userinfo字符串扫描人信息
                HashMap userInfo = gson.fromJson(vxUserInfo,HashMap.class);
                String nickname = (String) userInfo.get("nickname"); //vx名称
                String headimgurl = (String) userInfo.get("headimgurl"); //vx 头像
            ...
            String shortToken = "redirect:http://localhost:3000?token="+jwtToken;
